...
class TopicViews:
    ...
    def create_glossary_tab():
        ...
        with gr.Tab("용어/규칙/운동법", elem_id="glossary_tab"):
            ...
            # 빠른 쿼리 버튼 추가
            with gr.Row():
                terms_query_btn = gr.Button("📖 용어/규칙/운동법 정보 요청", variant="primary", size="lg")
        ...
        return {
            'terms_query_btn': terms_query_btn,
    ...
    def create_diet_tab():
        ...
        with gr.Tab("식단/회복", elem_id="diet_recovery_tab"):
            ...
            # 빠른 쿼리 버튼 추가
            with gr.Row():
                diet_query_btn = gr.Button("🍎 식단/회복 정보 요청", variant="primary", size="lg")
    ...
    def create_certification_tab():
        ...
        with gr.Tab("인증/챌린지 안내", elem_id="certification_tab"):
            ...
            # 빠른 쿼리 버튼 추가
            with gr.Row():
                cert_query_btn = gr.Button("🎖️ 인증/챌린지 정보 요청", variant="primary", size="lg")
    ...
    def create_mentoring_tab():
        ...
        with gr.Tab("멘토링(초보 심리/동기)", elem_id="mentoring_tab"):
            ...
            # 빠른 쿼리 버튼 추가
            with gr.Row():
                mentoring_query_btn = gr.Button("🤝 멘토링 정보 요청", variant="primary", size="lg")
        ...
        return {
            'mentoring_query_btn': mentoring_query_btn,
